...
//
//     final deliveryOrderItemDetailModel = deliveryOrderItemDetailModelFromJson(jsonString);

import 'dart:convert';

DeliveryOrderItemDetailModel deliveryOrderItemDetailModelFromJson(String str) => DeliveryOrderItemDetailModel.fromJson(json.decode(str));

String deliveryOrderItemDetailModelToJson(DeliveryOrderItemDetailModel data) => json.encode(data.toJson());

class DeliveryOrderItemDetailModel {
  Data data;

  DeliveryOrderItemDetailModel({
    required this.data,
  });

  factory DeliveryOrderItemDetailModel.fromJson(Map<String, dynamic> json) => DeliveryOrderItemDetailModel(
